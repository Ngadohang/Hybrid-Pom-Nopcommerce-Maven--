...
public class AbstractPage {
	...
	public AbstractPage clickToNewPage(WebDriver driver, String pageName) {
		waitToElementClickable(driver, AbstractPageUser.DYNAMIC_LINK, pageName);
		clickToElement(driver, AbstractPageUser.DYNAMIC_LINK, pageName);

		switch (pageName) {
		case "Register":
			return PageManagerObject.getRegisterPageObject(driver);
		case "Log in":
			return PageManagerObject.getLoginPageObject(driver);
		case "Addresses":
			return PageManagerObject.getAddressPageObject(driver);
		case "My account":
			return PageManagerObject.getMyAccountPageObject(driver);
		case "Change password":
			return PageManagerObject.getChangePasswordPageObject(driver);
		case "Search":
